...
function exec(options, done) {
	...
	if (exports.args.E && exports.args.E.value) {
		platoOptions.eslintStatsPath = path.resolve(exports.args.E.value);
	}

	if (exports.args.P && exports.args.P.value) {
		platoOptions.projectRootPath = path.resolve(exports.args.P.value);
	}
