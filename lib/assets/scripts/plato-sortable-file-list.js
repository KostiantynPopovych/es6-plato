...
$(function sortable_file_list() {
  ...
  var _sortByChurnVsComplexity = function _sortByComplexity() {
    return _sortBy('data-churn-complexity');
  };
  ...
  var _byChurnVsComplexity = function() {
    _update_list(_sortByChurnVsComplexity());
    _update_metrics_order('churn vs complexity');
  };
	// styling
	...
	$('button#button-churn-vs-complexity').on('click', _byChurnVsComplexity);
