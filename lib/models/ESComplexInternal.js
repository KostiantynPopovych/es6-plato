...
const BabelParser =require('./BabelParserInternal').default;
const ESComplexModule = require('typhonjs-escomplex-module/dist/ESComplexModule');
const ESComplexProject = require('typhonjs-escomplex-project/dist/ESComplexProject');
...
class ESComplexInternal
{
   ...
   */
	analyzeModule(source, options = {}, parserOptions = void 0, parserOverride = void 0)
	{
		...
		return this._escomplexModule.analyze(this.parse(source, parserOptions, parserOverride), options);
	}
...
module.exports = new ESComplexInternal();
